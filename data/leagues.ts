...
export const LEAGUES: League[] = [
  ...
  },
  {
    ...
    description: 'Aposta em todos os jogos da fase a eliminar. Resultado exacto vale 1 ponto extra, 1X2 vale 1 ponto.',
    type: 'regular',
    entryFee: 10,
    prizeDistribution: { first: 60, second: 30, third: 10 },
    matchPhase: 'cup',
