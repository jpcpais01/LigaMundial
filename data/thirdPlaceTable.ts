// Tabela oficial de atribuição dos 8 melhores terceiros classificados às
// posições da Ronda de 32 (Mundial 2026). Fonte: FIFA World Cup 2026
// Competition Regulations, Anexo C — todas as 495 combinações C(12,8) de
// grupos cujos terceiros se apuram.
//
// Chave: as 8 letras (ordenadas) dos grupos cujos terceiros se apuram.
// Valor: vencedor do grupo (ex: "1E") → letra do grupo do 3º que defronta.
//
// Gerado a partir de github.com/gabrielcondesilva/bolao-copa2026 e validado
// (cobertura completa das 8 posições + elegibilidade) contra a fonte openfootball.
